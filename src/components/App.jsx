			...
			<div className="note-app__body">
				<form className="note-input" onSubmit={(e) => handlerSubmit(e)}>
					...
					<Input
						...
						placeholder="title"
					/>
					<TextArea name="body" className="note-input__body" placeholder="description"/>
							...
							<div className="note-item" key={note.id}>
								...
								<div className="note-item__action">
									<Button
										className="note-item__delete-button"
										onClick={() =>
											setArchive(archive.filter((n) => n.id !== note.id))
										}
									>
										Delete
									</Button>
									<Button
										...
										onClick={() => {
											note.archived = false;
											setArchive(archive.filter((n) => n.archived === true));
											setNotes([...notes, note]);
										}}
									>
										Active
