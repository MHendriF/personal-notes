...
const Header = (props) => {
    ...
    return (
        <div className='px-5 py-5 pb-5 h-full'>
            <a href='#'>
                <h5 className='text-xl font-semibold tracking-tight text-white'>{title.substring(0, 100)}</h5>
...
const Footer = (props) => {
    ...
    return (
        <div className='flex items-center justify-between px-5 pb-5'>
            ...
            <Button classname='bg-orange-600'>Archive</Button>
        </div>
    );
};
